  ...
  return (
    <>
      <div className="mx-auto min-h-screen max-w-7xl pt-24 md:pt-17">
        <div className="flex h-[calc(100vh-96px)] flex-col-reverse py-4 md:h-[calc(100vh-68px)] md:flex-row md:px-6">
          ...
          <div className="hidden md:block md:w-1/2">
            <div className="relative h-full w-full overflow-hidden rounded-2xl transition-all duration-500 hover:shadow-2xl">
              <img
                src={logo}
                alt="logo"
                loading="lazy"
